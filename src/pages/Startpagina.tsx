    ...
    <Layout>
      ...
      <section className="py-20">
        <div className="container max-w-[1440px]">
          ...
          {/* Responsive casino cards: mobiel = lijst, desktop = grid */}
          <div>
            <div className="block lg:hidden divide-y divide-gray-100">
              {casinos.slice(0, 9).map((casino) => (
                <CasinoCard
                  ...
                  layout="mobile"
                  className="!my-2 !rounded-xl !shadow-none !p-3.5"
                />
              ))}
            </div>
          ...
          <div className="mt-8 flex justify-center">
            <Button
              asChild
              className="bg-gradient-to-r from-gokkerz-green to-green-600 text-sm text-white hover:opacity-90 sm:text-base px-8 py-4"
            >
            ...
            {featuredBonuses.map((bonus, idx) => (
              <BonusCardRedesign
                ...
                offer={{
                  ...
                  freeSpins: (typeof bonus.amount === 'string' && bonus.amount.toLowerCase().includes('free spin')) ? parseInt(bonus.amount.replace(/[^0-9]/g, '')) : 0,
